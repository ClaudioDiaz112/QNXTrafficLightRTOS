...
void intersection_SM(enum states *current_State, void *sensors)
{
  ...
  case State5:
    //		   state,	N,	S,	 E,	 W,	NLeft,	SLeft,	ELeft, 	WLeft,	NPed,	SPed,	EPed,	WPed, 	light state structure
    state_function(5, RED, GREEN, RED, GREEN, RED, RED, RED, RED, RED, RED, RED, RED, &Intersection2);
    if (peak_state == OFFPEAK)
    {
      if (boom_state == 0)
        *current_State = State1;
  ...
  case State6:
    //		   state,	N,	S,	 E,	 W,	NLeft,	SLeft,	ELeft, 	WLeft,	NPed,	SPed,	EPed,	WPed, 	light state structure
    state_function(6, RED, GREEN, RED, OFF, RED, RED, RED, RED, GREEN, GREEN, RED, RED, &Intersection2);
  ...
  case State7:
    //		   state,	N,	S,	 E,	 W,	NLeft,	SLeft,	ELeft, 	WLeft,	NPed,	SPed,	EPed,	WPed, 	light state structure
    state_function(7, RED, GREEN, RED, OFF, RED, RED, RED, RED, FLASHING_RED, FLASHING_RED, RED, RED, &Intersection2);
  ...
  case State8:
    //		   state,	N,	S,	 E,	 W,	NLeft,	SLeft,	ELeft, 	WLeft,	NPed,	SPed,	EPed,	WPed, 	light state structure
    state_function(8, RED, YELLOW, RED, OFF, RED, RED, RED, RED, RED, RED, RED, RED, &Intersection2);
...
void *Client(void *data)
{
  ...
  intersection_msg.ClientID = 300;  // unique number for this client
